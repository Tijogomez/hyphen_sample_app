...
final listRefreshKey = GlobalKey<RefreshIndicatorState>();
final List<Jobs> JobsInfoList = List.generate(jobnmbr.length,
...
class _JobTestScreenState extends State<JobTestScreen> {
  _refreshData() {
    return Future.delayed(const Duration(seconds: 1), () {
      setState(() {
        JobSection = filterData(JobsInfoList);
      });
    });
  }
